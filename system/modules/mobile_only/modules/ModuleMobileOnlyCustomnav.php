 ...
 */
class ModuleMobileOnlyCustomnav extends \Module {
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### MOBILE ONLY CUSTOMNAV ###';
	...
	protected function compile()
	{
    	...
    	$arrPages = array_values(array_filter($arrPages,function($v){
            $mobile = \Environment::get('agent')->mobile;

            // remove pages based on pc and mobile only
            if( $mobile && $v->pc_only ) {
                return false;
            }
